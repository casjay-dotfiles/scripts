...
TERMBIN_COM_ERROR_MESSAGE="${TERMBIN_COM_ERROR_MESSAGE:-Well something seems to have gone wrong}"
...
[ -f "$TERMBIN_COM_CONFIG_DIR/$TERMBIN_COM_CONFIG_FILE" ] || [[ "$*" = "--config" ]] || INIT_CONFIG=TRUE __gen_config ${SETARGS:-$@}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
