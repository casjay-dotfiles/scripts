...
TRANSFER_SH_TEMP_DIR="${TRANSFER_SH_TEMP_DIR/system_scripts/transfer.sh:-$HOME/.local/tmp/system_scripts/transfer.sh}"
TRANSFER_SH_TEMP_FILE="${TRANSFER_SH_TEMP_DIR:-$HOME/.local/tmp/transfer.sh}"
