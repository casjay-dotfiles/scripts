...
dockermgr_install() {
  ...
  DOCKER_REGISTRY_ORG_REPO="${DOCKER_REGISTRY_ORG_REPO:-$APPNAME}"
  DOCKER_REGISTRY_ORG_USER="${DOCKER_REGISTRY_ORG_USER:-casjaysdevdocker}"
  INSTDIR="${SET_INSTDIR-${INSTDIR:-$HOME/.local/share/CasjaysDev/dockermgr/$APPNAME}}"
  APPDIR="${SET_APPDIR:-${APPDIR:-/var/lib/srv/$USER/docker/$DOCKER_REGISTRY_ORG_USER/$DOCKER_REGISTRY_ORG_REPO/$DOCKER_HUB_IMAGE_TAG}}"
  DATADIR="${SET_DATADIR:-${DATADIR:-/var/lib/srv/$USER/docker/$DOCKER_REGISTRY_ORG_USER/$DOCKER_REGISTRY_ORG_REPO/$DOCKER_HUB_IMAGE_TAG}}"
  USRUPDATEDIR="$SHARE/CasjaysDev/apps/$SCRIPTS_PREFIX"
  SYSUPDATEDIR="$SYSSHARE/CasjaysDev/apps/$SCRIPTS_PREFIX"
  ARRAY="${ARRAY:-}"
  LIST="${LIST:-}"
