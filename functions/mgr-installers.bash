...
dockermgr_install() {
  ...
  APPDIR="${SET_APPDIR:-${APPDIR:-/srv/$USER/docker/$DOCKER_REGISTRY_USER_NAME/$DOCKER_REGISTRY_REPO_NAME/$DOCKER_HUB_IMAGE_TAG}}"
  DATADIR="${SET_DATADIR:-${DATADIR:-/srv/$USER/docker/$DOCKER_REGISTRY_USER_NAME/$DOCKER_REGISTRY_REPO_NAME/$DOCKER_HUB_IMAGE_TAG}}"
