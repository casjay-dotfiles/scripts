...
[ -f "\$GEN_SCRIPT_REPLACE_CONFIG_DIR/\$GEN_SCRIPT_REPLACE_CONFIG_FILE" ] || [[ "\$*" = *config ]] || INIT_CONFIG="\${INIT_CONFIG:-TRUE}" __gen_config \${SETARGS:-\$@}
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Import config
[ -f "\$GEN_SCRIPT_REPLACE_CONFIG_DIR/\$GEN_SCRIPT_REPLACE_CONFIG_FILE" ] && . "\$GEN_SCRIPT_REPLACE_CONFIG_DIR/\$GEN_SCRIPT_REPLACE_CONFIG_FILE"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
