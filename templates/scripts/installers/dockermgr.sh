...
CONTAINER_API_KEY_ENV_NAME="${ENV_CONTAINER_API_KEY_ENV_NAME:-$CONTAINER_API_KEY_ENV_NAME}"
...
CONTAINER_USER_ADMIN_HASH_PASS="\${ENV_CONTAINER_USER_ADMIN_PASS_HASH:-$CONTAINER_USER_ADMIN_HASH_PASS}"
