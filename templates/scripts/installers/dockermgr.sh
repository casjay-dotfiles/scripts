...
GEN_SCRIPT_REPLACE_APPENV_APPNAME_USERNAME="${GEN_SCRIPT_REPLACE_APPENV_APPNAME_USERNAME:-$DEFAULT_USERNAME}"
GEN_SCRIPT_REPLACE_APPENV_APPNAME_PASSWORD="${GEN_SCRIPT_REPLACE_APPENV_APPNAME_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
CONTAINER_USER_NAME="${GEN_SCRIPT_REPLACE_APPENV_APPNAME_USERNAME:-} "
CONTAINER_USER_PASS="${GEN_SCRIPT_REPLACE_APPENV_APPNAME_PASSWORD:-}"
