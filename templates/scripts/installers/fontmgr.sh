...
# Defaults
APPNAME="GEN_SCRIPT_REPLACE_APPNAME"
APPDIR="$HOME/.local/share/CasjaysDev/fontmgr/GEN_SCRIPT_REPLACE_APPNAME"
INSTDIR="$HOME/.local/share/CasjaysDev/fontmgr/GEN_SCRIPT_REPLACE_APPNAME"
REPO="https://github.com/fontmgr/GEN_SCRIPT_REPLACE_APPNAME"
REPORAW="https://github.com/fontmgr/GEN_SCRIPT_REPLACE_APPNAME/raw/$REPO_BRANCH"
APPVERSION="$(__appversion "https://github.com/fontmgr/GEN_SCRIPT_REPLACE_APPNAME/raw/$REPO_BRANCH/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
